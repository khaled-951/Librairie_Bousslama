...
if (isset($_POST['id']) and isset($_POST['name']) and isset($_POST['address']) and isset($_POST['phone']) and isset($_POST['informations'])and isset($_POST['DateDebut'])and isset($_POST['DateFin'])){
	$targetDir = "uploads/";
