...
<head>
    ...
    <title>Librairie Bousslema</title>
...
<div class="row">
		<div class="col-md-4">
			<h3 class="text-center text-info">Add Promotions</h3>
            <hr>
...
<div class="form-group">
<input type="text" name="nom" class="form-control" placeholder="Enter Name Of the Product" >
</div>

                <div class="form-group">
<input type="number" name="prix_ancien" class="form-control" placeholder="Enter your old Price">
</div>
...
<script language="javascript" type="text/javascript">
			...
			<textarea   name="description" onblur="calculeLongueur();" onfocus="calculeLongueur();" onkeydown="calculeLongueur();" onkeyup="calculeLongueur();"  id="autre" class="form-control" placeholder="Informations About the products" ></textarea>
						</div>
...
foreach($listePromo as $row){
	...
	<td><img width="80" src="uploads/<?php echo $row['image']?>" alt="<?php echo $row['image'] ?>"></td>
	<td><form method="POST" action="supprimePromo.php">
	<input type="submit" name="supprimer" value="supprimer">
	<input type="hidden" value="<?PHP echo $row['id']; ?>" name="id">
	</form>
	</td>
	<td><a href="modifiePromo.php?id=<?PHP echo $row['id']; ?>">
	Modifier</a></td>
	</tr>
	<?PHP
}
