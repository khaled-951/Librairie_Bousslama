...
<div class="form-group">
<input class="form-control" required pattern="[0-9.]{1,12}" placeholder="Enter your old Price" type="number" name="prix_ancien" value="<?PHP echo $prix_nouveau ?>">
</div>
...
if (isset($_POST['modifier'])){
	$Promo=new Promo($_POST['id'],$_POST['nom'],$_POST['image'],$_POST['prix_ancien'],$_POST['prix_nouveau'],$_POST['description']);
