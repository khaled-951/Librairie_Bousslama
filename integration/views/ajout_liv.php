	...
	<div class="section">
		...
		<div class="container">
			...
			<div class="row">
                ...
                <form  action="livraisonphp.php" id="checkout-form" name="livaddd" class="clearfix" method="POST"  >
					<div class="col-md-6">
						<div class="billing-details">

							<div class="section-title">
								<h3 class="title">Ajouter une livraison</h3>
							</div>

							<div class="form-group">
								<input class="input" required pattern="[a-zA-Z]{3,12}"  type="text" name="nom_destinataire" placeholder="Nom destinataire">
							</div>
							<div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="date" required name="date_livraison_estimer" >
                            </div>
						</div>
                        <div class="pull-left">
