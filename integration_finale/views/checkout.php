...
{
	$Order->add($_SESSION['idclient'], $_GET['first-name'], $_GET['last-name'], $_GET['email'], $_GET['address'], $_GET['city'], $_GET['country'], $_GET['zip-code'], $_GET['tel']);
	echo "<script>window.location.href='panier.php'</script>" ;
}

if(	isset($_GET['Delete_Order']) && isset($_SESSION['idclient']) )
					...
					<div class="col-md-12">
						<div class="order-summary clearfix">
							<div class="pull-right">
								<input type="submit" class="primary-btn" value="Place Order" id="botna" onclick="test()" ></input>
							</div>
						</div>
