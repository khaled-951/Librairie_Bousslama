				...
				<div class="product product-details clearfix">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<p><strong>Description :</strong> <?php echo $row['informations'] ?></p>
								
                                <p><strong>Date Debut :</strong> <?php echo $row['DateDebut'] ?></p>
                                <p><strong>Date Fin :</strong> <?php echo $row['DateFin'] ?></p>
