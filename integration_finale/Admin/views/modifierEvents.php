...
<input class="form-control" required pattern="[0-9a-zA-Z,/ .]{3,20}" placeholder="Enter Name Of the Event" type="text" name="name" value="<?PHP echo $name ?>">
</div>
...
<div class="form-group">
<textarea class="form-control" required pattern="[0-9a-zA-Z,/.]{3,12}" placeholder="Informations About the Events" name="informations" value="<?PHP echo $informations ?>"></textarea>
</div>

<div class="form-group">
<input class="form-control" required placeholder="DateDebut" id="date2" type="Date" name="DateDebut" value="<?PHP echo $DateDebut ?>">
</div>

<div class="form-group">
<input class="form-control" required placeholder="DateFin" id="date1" type="Date" name="DateFin" value="<?PHP echo $DateFin ?>">
</div>
...
<div class="form-group">
<input  type="hidden" name="id_ini" value="<?PHP echo $_GET['id'];?>" onclick=" return compar()">
</div>
...
if (isset($_POST['modifier'])){
	$events=new Events($id,$_POST['name'],$_POST['address'],$_POST['phone'],$_POST['informations'],$_POST['DateDebut'],$_POST['DateFin'],$_POST['photo']);
