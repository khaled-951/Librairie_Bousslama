<?php 
 include_once 'C:/wamp64/www/Librairie_Bousslama/integration/config.php';


 $db=config::getConnexion();

    $sql = ("SELECT COUNT(*) as num FROM utilisateur WHERE `sexe`='femme'");
  ...
  while ($row=$result->fetch()) {
   ...
   $sql = ("SELECT COUNT(*) as num FROM utilisateur WHERE `sexe`='homme'");
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Utilisateurs / Afficher Statistiques </li>
        </ol>
        <br><br><br>
        <div>
         <!-- GESTION UTILISATEUR -->
