...
<body id="page-top">
 ...
 <div class="row">
     <div class="col-md-3">
       <h3 class="text-center text-info">Update Promo</h3>
             <hr>
 ...
 if (isset($_POST['modifier'])){
  ...
  $tauxx=$promocc->calcultaux($prix,$priiix);
   ...
   $Promo=new Promo($id,$_POST['idProd'],$_POST['date_debut'],$_POST['date_fin'],$_POST['prix_nouveau'],$_POST['description'],$tauxx);
   ...
   echo ("<script> window.location.replace(\"check_out.php\")</script>");
	...
	echo("<script> document.Location.replace(\"modifiePromo.php\")</script>");
