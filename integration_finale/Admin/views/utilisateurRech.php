...
if(empty($_POST['search'])==false){
 $x=$_POST['search'];
    $listeUtilisateurs=$utilisateurC->rechercheUtilisateur($x);}
else
$listeUtilisateurs=$utilisateurC->trierUtilisateur();
            ...
            <div class="table-responsive">
              <table class="table table-bordered"   width="100%" cellspacing="0">
                <thead>
                  ...
                  <!--TRI-->
                    <a href="trierUtilisateur.php">
                    <input type="submit" value="trier Par ID "  class="btn btn-primary">
                    </a>
                <!--FIN TRI-->

                <!-- RECHERCHE -->
                <br>
                  <form method="POST" action="utilisateurRech.php">
                      <input type="text" id="arearech" name="search" placeholder="Taper l'id à rechercher ... " required>
